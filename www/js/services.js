...
.factory('FrasesService', function() {

  return {
    getFrases : function() {
      return [
        'Lo que caracteriza a Dios: no exigir sino el puro amor; el que no necesita nada, nada pide sino ser amado.',
        ...
        'Hay que presentarse a Dios con el sentimiento de nuestra nada: es la disposición más conforme a la verdad.',
